...
driver.get("https://attabotics-hivemind-test.azurewebsites.net/commissioning/ants")


time.sleep(6)


searchAnt = driver.find_element_by_xpath('//*[@id="application"]/div[3]/div/div[1]/div/div[1]/div[3]/div/input')
...
searchAnt.send_keys("JA265")

searchAnt.send_keys(Keys.RETURN)

time.sleep(6)


accessAnt = driver.find_element_by_xpath('//*[@id="application"]/div[3]/div/div[1]/div/div[3]/div/table/tbody/tr/td[1]/a/i')

accessAnt.click()

time.sleep(6)

## Validation output     asset for unit test execution and if statements for script validation

assert "JA265" in driver.page_source

if "JA265" and "4fae14f9-8558-178a-1e2a-acc4a3f810f9" in driver.page_source:
