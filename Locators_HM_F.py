...
class ri_locators():
    ri_page = 'https://attabotics-hivemind-test-feature.azurewebsites.net/manufacturing/robot_identities'
...
class assemblies_locators():
    assign_page = 'https://attabotics-hivemind-test-feature.azurewebsites.net/manufacturing/assemblies/assign_serial_number'    
    ...
    parent_page = 'https://attabotics-hivemind-test-feature.azurewebsites.net/manufacturing/assemblies/parent_serial_number'    
...
class capbanks_locators():
    cb_page = 'https://attabotics-hivemind-test-feature.azurewebsites.net/commissioning/cap_banks'
...
class tsb_locators():
    tsb_page = 'https://attabotics-hivemind-test-feature.azurewebsites.net/commissioning/bulletins'
